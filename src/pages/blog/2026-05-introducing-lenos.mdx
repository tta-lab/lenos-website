...
The next milestone is the full Terminal Bench 2.0 run across the model surface lenos targets — gpt-5.4, deepseek-v4-pro, deepseek-v4-flash, mimo-v2.5, and mimo-v2.5-pro. The placeholder numbers on the [benchmarks page](/lenos-website/benchmarks) get replaced with real ones the moment that run lands.
